...
var Img = function Img(_ref) {
  var _ref$className = _ref.className,
      ...
      otherProps = _objectWithoutProperties(_ref, ["className", "placeholder", "onError", "size", "src", "acss"]);
  ...
  if (!src || imgLoadError) {
    return /*#__PURE__*/_react.default.createElement(_Placeholder.default, _extends({
