...
var Container = function Container(_ref) {
  var _ref$Component = _ref.Component,
      ...
      acssWhenSize = _ref$acssWhenSize === void 0 ? 'dib vam pr oh br100p' : _ref$acssWhenSize,
      _ref$className = _ref.className,
      className = _ref$className === void 0 ? '' : _ref$className,
      size = _ref.size,
      otherProps = _objectWithoutProperties(_ref, ["Component", "acss", "acssWhenSize", "className", "size"]);
